...
<head>
    ...
    <title>RuangAdmin - Data gallery</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('Admin/gallery/Add'); ?>"
            ...
            <?php foreach ($gallery as $row):
                ...
                $gambar = $row->gambar;
                ?>
                <div class="modal fade" id="ModalHapus<?php echo $id_gallery; ?>" tabindex="-1" role="dialog"
                    aria-labelledby="">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url() . 'Admin/gallery/delete' ?>"
                                method="post">
                                <div class="modal-body">
            ...
            <?php foreach ($gallery as $row):
                ...
                ?>
                <div class="modal fade" id="ModalEdit<?php echo $id_gallery; ?>" tabindex="-1" role="dialog"
                    aria-labelledby="">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <!--    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button> -->
                                <h4 class="modal-title" id="myModalLabel">update gallery</h4>
                            </div>
                            <form class="form-horizontal" action="<?php echo base_url() . 'Admin/gallery/Update' ?>"
                                method="post">
                                <div class="modal-body">
                                    <div class="row mt-2">
                                        <div class="col-md-12">
